    ...
    return (
        <div className="bg-background ml-74 mt-10 mr-10">
            <DashboardCard>
                ...
                <form className="flex flex-col gap-6 w-120" onSubmit={handleSubmit}>
                    <Input name="list-name" title="List Name" placeholder="List Name" highlight={highlightListName}/>
                    <Input name="description" title="Description" placeholder="Description" highlight={highlightDescription}/>
